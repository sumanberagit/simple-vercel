...
const get_appointments_for_doctor = async (req, res) => {
  const doctorId = req.id; // Assume the doctor's ID is stored in req.id after authentication
  try {
...
module.exports = { all_appointments, create_appointments, user_query, ambulance_booking, single_appointments, single_user, update_user, get_appointments_for_doctor };
